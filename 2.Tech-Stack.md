...
Each git repo is independently versioned, built, and deployed. No pnpm workspaces across repos. Shared code only via versioned `@ecom/contracts` (installed with pnpm).

```
# Repo: ecom-contracts (pnpm package @ecom/contracts — semver, see 8.Versioning.md)
ecom-contracts/
